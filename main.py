...
class Ufo(GameSprite):
    def __init__(self):
        super().__init__("images/ufo/ufo.png", randint(0, WIDTH - 150), randint(-HEIGHT, -150), 150, 75, 2)
        self.wait = 0
        self.is_dead = False
        self.dead_frame = 0
    ...
    def respawn(self):
        ...
        self.image = transform.scale(image.load("images/ufo/ufo.png"), (self.rect.width, self.rect.height))
        self.is_dead = False
        self.dead_frame = 0
...
class BossUfo(GameSprite):
    def __init__(self):
        ...
        self.is_dead = False
        self.dead_frame = 0
        super().__init__("images/ufo/ufo.png", randint(0, WIDTH - 250), -170, 250, 125, 1)
    ...
    # def respawn(self):
    #    self.rect.x = randint(0, WIDTH - 250)
    #    self.rect.y = randint(-HEIGHT, -250)


class Bullet(GameSprite):
    def __init__(self, x, y):
        super().__init__("images/bullet.png", x, y, 20, 40, 14)
        self.rect.centerx = x
...
text_lose = font_finish.render("YOU LOSE!", True, (255, 255, 255))

text_hp = font_finish.render("", True, (50, 255, 55))

animation_list = []
for i in range(1, 7):
    temp = image.load(f"images/ufo/ufo_{i}.png")
    animation_list.append(temp)

cartridge_x = 30
clip_group = []
for i in range(10):
    cartridge = GameSprite("images/bullet.png", cartridge_x, HEIGHT - 80, 20, 40, 0)
    cartridge_x += 20
...
while game:
    ...
    if not finish:
        ...
        virtual_surface.blit(text_hp, (1150, 30))
